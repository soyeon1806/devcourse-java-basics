...
class GenesisCar03 extends Car03{
    int price;
    ...
    */
    GenesisCar03(int speed, boolean operable, char grade, int price) {
    ...
    */
    GenesisCar03(int speed, boolean operable, char grade) {
        super(speed, operable, grade);
        this.price = 0;
    }
    ...
    /**
        3. 매개변수 2개를 받는 생성자 선언하기
            ...
            - price는 0으로 초기화하세요
    */
    GenesisCar03(int speed, boolean operable) {
...
public class Prac03_SuperConstructor {
    public static void main(String[] args) {
        GenesisCar03 genesisCar = new GenesisCar03(150, true);
